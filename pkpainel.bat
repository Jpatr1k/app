...
echo. ╔════════════════════════════════════════════════════╗
echo. ║                                                    ║
echo  ║  %w% Running Paraguaio Optimizer as Administrator...%b% ║
echo. ║                                                    ║
echo. ╚════════════════════════════════════════════════════╝
timeout /t 1 /nobreak > NUL
chcp 437 >nul 2>&1
...
echo.
echo             Paraguaio Optimizer is not running as Admin!
...
echo %w% - Loading ...%b%
cls 
md C:\paraguaio >nul 2>&1
echo %w% - Refreshing paraguaio resource folder %b%
timeout /t 1 /nobreak > NUL
del /s /q C:\paraguaio  >nul 2>&1
cls 
...
echo.                                   %p%░░░╚═╝░░░╚═╝░░╚══════╝╚══════╝░╚════╝░░╚════╝░╚═╝░░░░░╚═╝╚══════╝░
echo.                 %b%"══════════════════════════════════════════════════════════════════════════════════════════════════"%w%                                                                                                  
echo.                                %w%  Made by PARAGUAIO OPTIMIZER® 2024 %b%║%w% Version 4.0 %b%║%w% updated 12th of May 2024           
echo.                                                                                                   
echo.
...
:rON
chcp 437 >nul 
powershell -Command "Checkpoint-Computer -Description 'Paraguaio Optimizer Restore Point' -RestorePointType 'MODIFY_SETTINGS'" 
chcp 65001 >nul 
echo.
echo.
echo.
...
curl -g -k -L -# -o "%temp%\paraguaio.zip" "https://www.dropbox.com/scl/fi/wh4figt0lhorsc7ukqgv3/exm.zip?rlkey=fotqy2invkvuvgpwxmh6dsd0m&st=xg5ao5v3&dl=0" >nul 2>&1
cls
chcp 437 >nul 2>&1
powershell -NoProfile Expand-Archive '%temp%\paraguaio.zip' -DestinationPath 'C:\paraguaio' >nul 2>&1 
chcp 65001 >nul 2>&1
cls
goto menu
...
echo.       %w%                                                                                                                                          
echo.       %w%                                                                                                                                                                           
echo.       %w%                                  Made by PTK2K 2024 %b%║%w% Updated 12th of May                                        
echo.       %w%                                                                                                                  
echo.       %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"
...
:w6
cls
start C:\paraguaio\Windows_Update_Blocker.exe
echo.
echo.
echo.
echo.                                              %b%"═══════════════════════════════════════════════════════"
...
:8war
chcp 437 >nul 2>&1
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Do NOT do these if your pc has bad overheating issues', 'Paraguaio Optimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
timeout /t 1 /nobreak > nul
chcp 65001 >nul 2>&1
...
echo.                                                                                          
echo.                                                                                          
echo.                                           %p%[%w%1%p%]%w% Apply Paraguaio Power Plan V3               
echo.                                                                                           
...
:p1
cls
echo %w% Import Paraguaio Power Plan V3%b%
powercfg -import "C:\paraguaio\Paraguaio_Power_Plan_V3.pow"
powercfg.cpl
timeout /t 1 /nobreak > NUL
echo.
echo.
...
start "" /wait "C:\paraguaio\NvidiaProfileInspector.exe" "C:\paraguaio\Paraguaio_Settings_V5.nip" 
...
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('After you press ok it will open an app, Go to the LOGON section, disable all services except: antivirus, cmd.exe, and the n/a services', 'Paraguaio Optimizer', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul

start C:\paraguaio\autoruns.exe
echo.
echo.
echo.
echo.                                              %b%"═══════════════════════════════════════════════════════"
